...
class Video extends Model {
            ...
            avaliacaoAvg: {
                ...
                get() {
                    ...
                    if (this.avaliacoes && this.avaliacoes.length > 0) {
                        total = this.avaliacoes.reduce((sum, current) => sum + parseFloat(current.Avaliacao.pontuacao), 0);
    ...
    static associate(models) {
        ...
        this.belongsToMany(models.Usuario, { foreignKey: 'video_id', through: models.Avaliacao, as: 'avaliacoes' }) //M/M through nome da tabela
